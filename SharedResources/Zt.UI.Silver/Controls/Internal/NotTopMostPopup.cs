...
namespace Zt.UI.Silver.Controls.Internal
{
    internal class NotTopMostPopup : Popup
    {
        ...
        #region Event
        public static readonly RoutedEvent OpeningEvent = EventManager.RegisterRoutedEvent("Opening", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(MultiSelector));
        ...
        public static readonly RoutedEvent ClosingEvent = EventManager.RegisterRoutedEvent("Closing", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(MultiSelector));
